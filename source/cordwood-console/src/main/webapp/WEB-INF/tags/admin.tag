<%@ tag description="Admin Site Frame" pageEncoding="UTF-8"%>
...
<head>
    ...
    <spring:message var="keywords" code="site.keywords" />
    <meta name="description" content="${ keywords }">
    <spring:message var="author" code="site.author" />
        ...
        <div class="container">
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown user" id="header-user">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img alt="" src="/images/avatars/avatar3.jpg" />
