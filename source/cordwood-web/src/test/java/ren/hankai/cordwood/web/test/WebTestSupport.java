...
package ren.hankai.cordwood.web.test;
...
import ren.hankai.cordwood.web.test.config.TestWebConfig.TestBeanConfig;
...
@WebAppConfiguration
@ContextConfiguration(classes = {WebTestSupport.class, TestBeanConfig.class})
